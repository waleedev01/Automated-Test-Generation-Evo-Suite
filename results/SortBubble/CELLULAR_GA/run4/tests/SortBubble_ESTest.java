...
public class SortBubble_ESTest extends SortBubble_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      Integer[] integerArray2 = SortBubble.sort(integerArray1, integer0);
      Integer[] integerArray3 = SortBubble.sort(integerArray2, integer0);
      Integer integer1 = new Integer(1354);
      // Undeclared exception!
      try { 
        SortBubble.sort(integerArray3, integer1);
